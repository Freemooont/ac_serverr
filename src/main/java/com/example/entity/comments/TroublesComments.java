...
@Entity
@Table(name = "cl_troubles_comments")
public class TroublesComments implements Comments{
    @Id
    @GeneratedValue
    ...
    public TroublesComments() {
    }

    public TroublesComments(String body, Profile user, Long feed_id, Timestamp date_time) {
        this.body = body;
        this.user = user;
