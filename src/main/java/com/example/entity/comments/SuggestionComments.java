...
@Entity
@Table(name = "cl_suggestions_comments")
public class SuggestionComments implements Comments{
    @Id
    @GeneratedValue
    ...
    public SuggestionComments(String body, Profile user, Long feed_id, Timestamp date_time) {
        this.body = body;
        this.user = user;
