...
public interface VoteSuggestionRepository extends JpaRepository<VoteSuggestion , Long> {
    ...
    String CHECK_IF_EXIST = "SELECT * FROM cl_vote_suggestions t WHERE t.feed_id = :feed_id AND t.user_id = :user_id  ";
    ...
    VoteSuggestion checkIfExist(@Param("feed_id") Long feed_id, @Param("user_id") Long user_id) throws NullPointerException;
}
